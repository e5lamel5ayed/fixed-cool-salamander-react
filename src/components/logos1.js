...
Logos1.defaultProps = {
  ...
  logo3Alt: 'Carpentry Services',
  logo4Alt: 'Furniture Upholstery',
  logo5Src:
  ...
  logo5Alt: 'Electrical Repairs',
  logo6Alt: 'Appliance Fixing',
  logo6Src:
